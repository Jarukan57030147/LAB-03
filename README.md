...
1.	นักศึกษาพบปัญหาในการคอมไพล์โปรแกรมหรือไม่ ถ้าเจอให้บอกที่ผิดและแนวทางการแก้ไข
 ...
 พบปัญหาในการคอมไพล์โปแกรม เจอปัญหาตรงชนิดของข้อมูล การแก้ไขคือ สร้าง Project ใหม่ เป็นชนิด empty project เหมือนใบงานที่1เลย 
 โดยไม่ได้สร้างจาก project แบบ Win32 Project ก่อนแล้วค่อยเลือกแบบ empty project
